<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" name="visitante_id" class="form-control @error('visitante_id') is-invalid @enderror"
                value="{{ old('visitante_id', $visita?->visitante_id) }}" id="visitante_id"
                placeholder="Documento del visitante" list="visitante-id-list"
                oninput="updateVisitanteDatalist(this.value)">
    ...
    <div class="form-group mb-2 mb20">
        ...
        <input type="number" name="prisionero_id" class="form-control @error('prisionero_id') is-invalid @enderror"
            value="{{ old('prisionero_id', $visita?->prisionero_id) }}" id="prisionero_id"
            placeholder="Id del prisionero" list="prisionero-id-list" oninput="updatePrisioneroDatalist(this.value)">
    ...
    <div class="form-group mb-2 mb20">
        ...
        <input type="datetime-local" name="inicioVisita"
            class="form-control @error('inicioVisita') is-invalid @enderror"
            value="{{ old('inicioVisita', $visita?->inicioVisita) }}" id="inicio_visita"
            placeholder="Inicio de la visita">
    ...
    <div class="form-group mb-2 mb20">
        ...
        <input type="datetime-local" name="finVisita" class="form-control @error('finVisita') is-invalid @enderror"
            value="{{ old('finVisita', $visita?->finVisita) }}" id="fin_visita" placeholder="Fin de la visita">

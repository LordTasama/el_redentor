<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="nacimiento" class="form-control @error('nacimiento') is-invalid @enderror" value="{{ old('nacimiento', $prisionero?->nacimiento) }}" id="nacimiento" placeholder="Nacimiento">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="ingreso" class="form-control @error('ingreso') is-invalid @enderror" value="{{ old('ingreso', $prisionero?->ingreso) }}" id="ingreso" placeholder="Ingreso">

...
@enderror
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="documento" class="form-control @error('documento') is-invalid @enderror" value="{{ old('documento', $visitante?->documento) }}" id="documento" placeholder="Documento">
